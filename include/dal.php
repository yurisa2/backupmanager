...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("backupviewer_users");
}
...
class tDAL
{
	var $tblbackup_db__backups;
	var $tblbackup_db__backupviewer_uggroups;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "backups", "varname" => "backup_db__backups", "altvarname" => "backups", "connId" => "backup_db", "schema" => "", "connName" => "backupmanager at backupmanager.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "backupviewer_uggroups", "varname" => "backup_db__backupviewer_uggroups", "altvarname" => "backupviewer_uggroups", "connId" => "backup_db", "schema" => "", "connName" => "backupmanager at backupmanager.mysql.dbaas.com.br");
