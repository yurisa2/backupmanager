...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "backup_db";
		$data["connName"] = "backupmanager at backupmanager.mysql.dbaas.com.br";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;backupmanager.mysql.dbaas.com.br;backupmanager;Fokalove99;;backupmanager;;1"; //currently unused
		
		$this->_connectionsIdByName["backupmanager at backupmanager.mysql.dbaas.com.br"] = "backup_db";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "backupmanager";
		...
		$data["connInfo"][0] = "backupmanager.mysql.dbaas.com.br";
		$data["connInfo"][1] = "backupmanager";
		$data["connInfo"][2] = "Fokalove99";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "backupmanager";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=backupmanager.mysql.dbaas.com.br;Uid=backupmanager;Pwd=Fokalove99;Database=backupmanager;OPTION=3";
		// encription set
		...
		$connectionsData["backup_db"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["backups"] = "backup_db";
		$connectionsIds["admin_rights"] = "backup_db";
