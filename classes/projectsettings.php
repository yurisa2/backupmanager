...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("backupviewer_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "backups" ] = array( "url" => "backups", "type" => 0 );
	$projectEntitiesReverse[ "backups" ] = "backups";
	$projectEntities[ "admin_rights" ] = array( "url" => "admin_rights", "type" => 1 );
	$projectEntitiesReverse[ "admin_rights" ] = "admin_rights";
	$projectEntities[ "backupviewer_users" ] = array( "url" => "backupviewer_users", "type" => 0 );
	$projectEntitiesReverse[ "backupviewer_users" ] = "backupviewer_users";
	...
	$projectEntities[ "pings" ] = array( "url" => "pings", "type" => 0 );
	$projectEntitiesReverse[ "pings" ] = "pings";
}
